...
alias gitlab="cd $A15_PATH/ecomm-inventory"
alias tf="cd $A15_PATH/a15-stratus-terraform"
alias dstf="cd $A15_PATH/a15-ds-urbn-data-science-infra"
alias urbncat="cd $URBNCAT_PATH/urbncat"
alias urbie="cd $SEARCH_PATH/urbie"
